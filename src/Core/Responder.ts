...
/**
 * A responder, a HTTP request will be input, then this node will respond this request, convert this request to a response, output result response to next node.
 * 
...
export abstract class Responder extends Node {
     ...
     * @memberof Responder
     */
    public abstract respond(request: IRequest): Promise<IResponse>;
