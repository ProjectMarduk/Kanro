...
export namespace Kanro {
    export interface IExecutorsConfig {
        entryPoint: KanroCore.Config.IRequestHandlerConfig | KanroCore.Config.IRequestDiverterConfig | KanroCore.Config.IRequestReplicatorConfig | KanroCore.Config.IResponderConfig;
        globalExceptionHandlers: KanroCore.Config.IGlobalExceptionHandlerConfig[];
        globalRequestHandler: KanroCore.Config.IGlobalRequestHandlerConfig;
        globalResponseHandler: KanroCore.Config.IGlobalResponseHandlerConfig;
    }
    ...
    export class App {
        ...
        async reloadConfigs(config: Configs) {
            try {
        ...
        private async initialize(configs: Configs) {
    ...
    export class ModuleManager implements KanroCore.Core.IModuleManager, KanroCore.Core.IService {
    ...
    export class ServiceManager implements KanroCore.Core.IService {
        type: KanroCore.Core.ExecutorType.Service = KanroCore.Core.ExecutorType.Service;
    ...
    export class Configs {
        ...
        static async createFromConfigFiles(): Promise<Configs> {
            let result = new Configs();
    ...
    export class ConfigLoader {
        ...
        static async getExecutorsConfig(config: any = undefined): Promise<IExecutorsConfig> {
            try {
        ...
        static async getKanroConfig(config: any = undefined): Promise<IAppConfig> {
            try {
